          ...
          child: ListBody(
            children: <Widget>[
              ...
              if (infoFeed.data.iaqi.co != null)
                LineChart(value: infoFeed.data.iaqi.co.v, min: 0,max: 60,interval: 10,color: Colors.red, name: "CO  ",),
              if (infoFeed.data.iaqi.dew != null)
                LineChart(value: infoFeed.data.iaqi.dew.v, min: 0,max: 30,interval: 5,color: Colors.yellow, name: "DEW ",),
              if (infoFeed.data.iaqi.h != null)
                LineChart(value: infoFeed.data.iaqi.h.v, min: 0,max: 150,interval: 30,color: Colors.orange, name: "H   ",),
              ...
              if (infoFeed.data.iaqi.o3 != null)
                LineChart(value: infoFeed.data.iaqi.o3.v, min: 0,max: 50,interval: 10,color: Colors.deepPurple, name: "O3  ",),
              ...
              if (infoFeed.data.iaqi.pm10 != null)
                LineChart(value: infoFeed.data.iaqi.pm10.v.toDouble(), min: 0,max: 500,interval: 100,color: Colors.limeAccent, name: "Pm10",),
              if (infoFeed.data.iaqi.so2 != null)
               LineChart(value: infoFeed.data.iaqi.so2.v, min: 0,max: 30,interval: 5,color: Colors.pink, name: "SO2 ",),
              if (infoFeed.data.iaqi.t != null)
                LineChart(value: infoFeed.data.iaqi.t.v, min: 0,max: 40,interval: 5,color: Colors.indigo, name: "T   ",),
              if (infoFeed.data.iaqi.w != null)
                LineChart(value: infoFeed.data.iaqi.w.v, min: 0,max: 20,interval: 5,color: Colors.blueAccent, name: "W   ",),
            ],
          ),
        ));
  }
